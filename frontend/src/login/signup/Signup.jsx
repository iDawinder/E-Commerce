...
function Signup() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      let a =  await fetch("http://localhost:7000/register", {
       method: "POST",
       headers: {
  ...
  return (
    <div className="tw-flex tw-align-center tw-justify-center tw-my-10 form">
      <div className=" tw-bg-gray-300 tw-max-w-[380px]  tw-h-auto tw-rounded-xl tw-overflow-hidden sm:tw-mx-4">
        <h2 className="tw-bg-red-500 tw-p-7 tw-text-3xl tw-font-bold">
          SIGN UP
        </h2>
        <hr></hr>
        <form onSubmit={handleSubmit}>
          <div className="tw-px-16 ">
            ...
            <button
              type="submit"
              className=" tw-py-2 tw-px-7 tw-bg-red-500 tw-item-center tw-my-5 tw-rounded-2xl tw-font-bold"
            >
              Submit
            </button>
          </div>
